...
// Dynamic URL resolution: uses env var in CI/CD, falls back to localhost for dev server,
// and uses window.location.origin when served by Express in production.
